...
namespace pozitronik\arlogger\helpers;
...
class ReflectionHelper {
	...
	public static function GetClassNameFromFile(string $fileName):string {
		return self::ExtractNamespaceFromFile($fileName).'\\'.self::ChangeFileExtension($fileName);
	}
	 ...
	 * @return string
	 */
	private static function ChangeFileExtension(string $filename, string $new_extension = ''):string {
